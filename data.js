...
const CLAIMS = [
 ...
 {brand:'Amazon',claim:'“Readable reviews may help cautious shoppers assess suitability and support the client’s sales goal, but reviews can be misleading.”',answers:['Reject: analysis must only list features.','Keep the causal explanation; add a specific observation and evidence for the trade-off.','Remove the limitation so the site sounds better.'],correct:1,why:'This links a design choice to user and client outcomes. Evidence and a reasoned judgement strengthen analysis and evaluation; the predicted sales effect is not a measured result.'},
 {brand:'YouTube',claim:'“More viewing time proves a tutorial website is better for students.”',answers:['Agree: minutes watched are the only useful measure.','Reject all recommendations permanently.','Judge learning task success alongside engagement, accessibility and user control.'],correct:2,why:'Client and user goals can differ. Evaluate against the chosen purpose; longer sessions may mean interest, distraction or difficulty.'},
 {brand:'Google + Amazon',claim:'“A shopper lives in a rural village, so they definitely have slow internet.”',answers:['Challenge: location is known; connection speed needs separate evidence.','Agree: geography proves connection quality.','Move the clue into demographics.'],correct:0,why:'Rural location is geographic. Test on realistic connections without presenting an unsupported assumption as a fact.'},
 {brand:'Spotify',claim:'“They like discovering independent artists” and “they save five playlists a week” are the same type of clue.',answers:['Both are demographic.','The interest is psychographic; the saving frequency is behavioural.','Both are geographic.'],correct:1,why:'Motivation and behaviour may be related, but they are distinct evidence. Combining them can produce a more useful segment.'},
